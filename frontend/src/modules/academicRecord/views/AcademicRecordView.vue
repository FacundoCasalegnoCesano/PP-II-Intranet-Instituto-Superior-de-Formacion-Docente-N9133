...
async function load(): Promise<void> {
  ...
  try {
    ...
    error.value = 'No pudimos cargar tu trayectoria académica.'
  } finally {
    loading.value = false
  }
}
